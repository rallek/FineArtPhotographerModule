...
namespace RK\FineArtPhotographerModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use RK\FineArtPhotographerModule\Helper\FeatureActivationHelper;
use RK\FineArtPhotographerModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('RKFineArtPhotographerModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('rk_fineartphotographer_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('rk_fineartphotographer_module.category_helper');
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $objectType)) {
            $entities = $this->get('rk_fineartphotographer_module.category_helper')->filterEntitiesByPermission($entities);
        }
    
        // set a block title
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKFineArtPhotographerModule items');
        }
        ...
        $templateParameters = $this->get('rk_fineartphotographer_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('rk_fineartphotographer_module.category_helper'),
            'feature_activation_helper' => $this->get('rk_fineartphotographer_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@RKFineArtPhotographerModule/Block/itemlist_modify.html.twig';
    }
