...
use RK\FineArtPhotographerModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('RKFineArtPhotographerModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        $controllerReference = new ControllerReference('RKFineArtPhotographerModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@RKFineArtPhotographerModule/Block/item_modify.html.twig';
    }
