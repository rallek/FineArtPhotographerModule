...
namespace RK\FineArtPhotographerModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for album item entities.
 */
abstract class AbstractAlbumItemRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'RK\FineArtPhotographerModule\Entity\AlbumItemEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'image';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'RKFineArtPhotographerModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'album items', 'userid' => $userId];
     ...
     *
     * @return array|albumItemEntity Retrieved data array or albumItemEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved albumItemEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('albumItem', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('albumItem', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numAlbumItems';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('albumItem', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of album items to exclude (optional)
     *
     * @return boolean Result of this check, true if the given album item does not already exist
     */
