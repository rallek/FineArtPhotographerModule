...
abstract class AbstractAlbumRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'RK\FineArtPhotographerModule\Entity\AlbumEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'RKFineArtPhotographerModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'albums', 'userid' => $userId];
    ...
    public function genericBaseQuery($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (true === $slimMode) {
            ...
            $selection = 'tbl.id';
            $selection .= ', tbl.albumDate';
            $selection .= ', tbl.albumTitle';
            $useJoins = false;
        }
    ...
    {
        $qb->leftJoin('tbl.albumItems', 'tblAlbumItems');
