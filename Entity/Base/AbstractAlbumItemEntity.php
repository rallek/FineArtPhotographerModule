...
abstract class AbstractAlbumItemEntity extends EntityAccess implements Translatable
{
     ...
     * @Assert\NotBlank()
     * @FineArtPhotographerAssert\ListEntry(entityName="albumItem", propertyName="workflowState", multiple=false)
    ...
    /**
     * @ORM\OneToMany(targetEntity="\RK\FineArtPhotographerModule\Entity\AlbumItemCategoryEntity", 
     *                mappedBy="entity", cascade={"all"}, 
     *                orphanRemoval=true)
     * @var \RK\FineArtPhotographerModule\Entity\AlbumItemCategoryEntity
     */
     ...
     *
     * @ORM\ManyToOne(targetEntity="RK\FineArtPhotographerModule\Entity\AlbumEntity", inversedBy="albumItems")
     * @ORM\JoinTable(name="rk_faph_album")
     * @Assert\Type(type="RK\FineArtPhotographerModule\Entity\AlbumEntity")
     * @var \RK\FineArtPhotographerModule\Entity\AlbumEntity $album
     */
    protected $album;
     ...
     * @param \RK\FineArtPhotographerModule\Entity\AlbumItemCategoryEntity $element Element to search for
     *
     * @return bool|int
     */
    private function collectionContains(ArrayCollection $collection, \RK\FineArtPhotographerModule\Entity\AlbumItemCategoryEntity $element)
    {
        foreach ($collection as $key => $category) {
            /** @var \RK\FineArtPhotographerModule\Entity\AlbumItemCategoryEntity $category */
     ...
     * Sets the album.
     *
     * @param \RK\FineArtPhotographerModule\Entity\AlbumEntity $album
     *
     * @return void
     */
    ...
    {
        return 'rkfineartphotographermodule.ui_hooks.albumitems';
    }
