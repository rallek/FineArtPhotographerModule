...
namespace RK\FineArtPhotographerModule\Entity\Factory\Base;

use Doctrine\Common\Persistence\ObjectManager;
use Doctrine\ORM\EntityRepository;
use InvalidArgumentException;
use RK\FineArtPhotographerModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'RK\\FineArtPhotographerModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return RK\FineArtPhotographerModule\Entity\albumEntity The newly created entity instance
     */
    public function createAlbum()
    {
        $entityClass = 'RK\\FineArtPhotographerModule\\Entity\\AlbumEntity';
     ...
     *
     * @return RK\FineArtPhotographerModule\Entity\albumItemEntity The newly created entity instance
     */
    public function createAlbumItem()
    {
        $entityClass = 'RK\\FineArtPhotographerModule\\Entity\\AlbumItemEntity';
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'RKFineArtPhotographerModule:' . ucfirst($objectType) . 'Entity';
