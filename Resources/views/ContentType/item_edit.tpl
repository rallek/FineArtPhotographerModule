...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='rKFineArtPhotographerModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
    ...
    <div{* class="form-group"*}>
        <p>{gt text='Please select your item here. You can resort the dropdown list and reduce it\'s entries by applying filters. On the right side you will see a preview of the selected entry.' domain='rkfineartphotographermodule'}</p>
        {rkfineartphotographermoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
    ...
    <div{* class="form-group"*}>
        ...
        <div class="col-sm-9">
            ...
            <span class="help-block">{gt text='Example' domain='rkfineartphotographermodule'}: <em>displaySpecial.html.twig</em></span>
            <span class="help-block">{gt text='Needs to be located in the "External/YourEntity/" directory.' domain='rkfineartphotographermodule'}</span>
        </div>
    </div>
</div>
