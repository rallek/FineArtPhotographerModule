...
function rKFineArtPhotographerToday(format) {
...
function rKFineArtPhotographerReadDate(val, includeTime) {
...
function rKFineArtPhotographerValidateNoSpace(val) {
    var valStr;
...
function rKFineArtPhotographerValidateUploadExtension(val, elem) {
