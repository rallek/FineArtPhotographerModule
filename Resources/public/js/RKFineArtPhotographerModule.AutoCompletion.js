 ...
 */
function rKFineArtPhotographerToggleAutoCompletionFields(idPrefix) {
 ...
 */
function rKFineArtPhotographerResetAutoCompletion(idPrefix) {
    // hide the sub form
    rKFineArtPhotographerToggleAutoCompletionFields(idPrefix);
 ...
 */
function rKFineArtPhotographerRemoveRelatedItem(idPrefix, removeId) {
 ...
 */
function rKFineArtPhotographerSelectResultItem(objectType, idPrefix, selectedListItem, includeEditing) {
    ...
    if (true === includeEditing) {
        li.append(rKFineArtPhotographerCreateInlineEditLink(objectType, idPrefix, elemPrefix, newItemId));
    }

    li.append(
        jQuery('<a />', {
            id: elemPrefix + 'Remove',
            href: 'javascript:rKFineArtPhotographerRemoveRelatedItem(\'' + idPrefix + '\', ' + newItemId + ');',
            text: 'remove'
        }).append(
    ...
    if (true === includeEditing) {
        rKFineArtPhotographerInitInlineEditLink(objectType, idPrefix, elemPrefix, newItemId, 'autocomplete');
    }
 ...
 */
function rKFineArtPhotographerSelectHookItem(objectType, idPrefix, selectedListItem) {
    rKFineArtPhotographerResetAutoCompletion(idPrefix);
    rKFineArtPhotographerAttachHookObject(jQuery('#' + idPrefix + 'AddLink'), selectedListItem.id);
}
        ...
        jQuery('#' + idPrefix + 'Selector').autocomplete({
            ...
            select: function (event, ui) {
                if (true === isHookAttacher) {
                    rKFineArtPhotographerSelectHookItem(objectType, idPrefix, ui.item);
                } else {
                    rKFineArtPhotographerSelectResultItem(objectType, idPrefix, ui.item, includeEditing);
                }
