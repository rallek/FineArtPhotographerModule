 ...
 */
abstract class AbstractAlbumUiHooksProvider implements HookProviderInterface
{
    use ServiceIdTrait;
    ...
    /**
     * AlbumUiHooksProvider constructor.
     *
    ...
    {
        return $this->translator->__('Album ui hooks provider');
    }
    ...
    {
        return 'provider.rkfineartphotographermodule.ui_hooks.albums';
    }
    ...
    {
        return 'RK\FineArtPhotographerModule\Entity\HookAssignmentEntity';
    }
    ...
    protected function selectAssignedEntities(Hook $hook)
    {
        ...
        $entities = $this->entityFactory->getRepository('album')->selectByIdList($assignedIds);
    ...
    protected function renderDisplayHookResponse(Hook $hook, $context)
    {
        ...
        $template = '@RKFineArtPhotographerModule/Album/includeDisplayItemListMany.html.twig';
