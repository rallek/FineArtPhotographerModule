...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from fine art photographer app';
     *     $event->getRequest()->attributes->set('RKFineArtPhotographerModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('RKFineArtPhotographerModule_test');`
     *     now `$testMessage` should be: `'Hello from fine art photographer app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('fine art photographer App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
