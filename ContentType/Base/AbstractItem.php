...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKFineArtPhotographerModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single RKFineArtPhotographerModule object.');
    }
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('RKFineArtPhotographerModule:External:display', $this->getDisplayArguments(), ['template' => $this->customTemplate]);
