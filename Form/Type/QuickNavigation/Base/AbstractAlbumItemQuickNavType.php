...
namespace RK\FineArtPhotographerModule\Form\Type\QuickNavigation\Base;
...
/**
 * Album item quick navigation form type base class.
 */
abstract class AbstractAlbumItemQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * AlbumItemQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'RK\FineArtPhotographerModule\Entity\\' . ucfirst($objectType) . 'CategoryEntity',
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('album', EntityType::class, [
            'class' => 'RKFineArtPhotographerModule:AlbumEntity',
    ...
    {
        $listEntries = $this->listHelper->getEntries('albumItem', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'rkfineartphotographermodule_albumitemquicknav';
    }
}
