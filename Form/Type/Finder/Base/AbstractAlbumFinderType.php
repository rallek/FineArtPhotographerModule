...
/**
 * Album finder form type base class.
 */
abstract class AbstractAlbumFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        return 'rkfineartphotographermodule_albumfinder';
    }
