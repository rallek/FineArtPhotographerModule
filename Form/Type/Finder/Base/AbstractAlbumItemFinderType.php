...
/**
 * Album item finder form type base class.
 */
abstract class AbstractAlbumItemFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * AlbumItemFinderType constructor.
     *
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'RK\FineArtPhotographerModule\Entity\\' . ucfirst($options['object_type']) . 'CategoryEntity',
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the album item') => 1,
                $this->__('Absolute url to the album item') => 2,
                $this->__('ID of album item') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the album item') => 8,
                $this->__('Image with absolute url to the album item') => 9
            ],
    ...
    {
        return 'rkfineartphotographermodule_albumitemfinder';
    }
