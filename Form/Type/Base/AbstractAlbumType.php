...
abstract class AbstractAlbumType extends AbstractType
{
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'entity' => 'AlbumEntity',
            'entityCategoryClass' => 'RK\FineArtPhotographerModule\Entity\AlbumCategoryEntity'
        ]);
    }
    ...
    {
        return 'rkfineartphotographermodule_album';
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'RK\FineArtPhotographerModule\Entity\AlbumEntity',
