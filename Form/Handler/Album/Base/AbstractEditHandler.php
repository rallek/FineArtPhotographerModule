...
namespace RK\FineArtPhotographerModule\Form\Handler\Album\Base;

use RK\FineArtPhotographerModule\Form\Handler\Common\EditHandler;
use RK\FineArtPhotographerModule\Form\Type\AlbumType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the album yet as other items are required which must be created before!'));
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKFineArtPhotographerModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'album', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
