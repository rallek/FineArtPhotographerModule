...
namespace RK\FineArtPhotographerModule\Twig\Base;
...
use RK\FineArtPhotographerModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkfineartphotographermodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkfineartphotographermodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkfineartphotographermodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkfineartphotographermodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkfineartphotographermodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('rkfineartphotographermodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkfineartphotographermodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkfineartphotographermodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkfineartphotographermodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkfineartphotographermodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkfineartphotographermodule_fileSize }}
     *
    ...
    /**
     * The rkfineartphotographermodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkfineartphotographermodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkfineartphotographermodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkfineartphotographermodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The rkfineartphotographermodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|rkfineartphotographermodule_formattedTitle }}
     *
